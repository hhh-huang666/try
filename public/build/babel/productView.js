  ...
  return _createClass(ProductView, [{
    ...
    value: function addNewProduct() {
      ...
      if (this.pdtTitle.value.trim().length >= 2) {
        ...
        var newProduct = {
          ...
          quantity: (0, _utils.clampQuantity)(this.pdtQty.innerText),
          ...
          persianDate: (0, _utils.formatDate)(now, (0, _i18n.getLang)())
        };
        // reset inputs
        this.pdtTitle.value = ' ';
        ...
        (0, _toast.showToast)("Product added", "success");
      } else {
    ...
    value: function showListedProducts(productList) {
      ...
      productList.forEach(function (product) {
        ...
        var dateText = product.createdAt ? (0, _utils.formatDate)(product.createdAt, lang) : product.persianDate || "";
        var t = (0, _utils.escapeHtml)(product.title);
        var l = (0, _utils.escapeHtml)(product.location);
        var c = (0, _utils.escapeHtml)(product.category);
        var d = (0, _utils.escapeHtml)(dateText);
        var q = (0, _utils.escapeHtml)((0, _utils.clampQuantity)(product.quantity));
        var id = (0, _utils.escapeHtml)(product.id);
        output += "\n                <li class=\"flex items-center justify-between  w-full py-2 bg-blue-400/ text-white font-medium ss:min-w-[500px] ss:overflow-x-auto \">\n                    <p class=\"  basis-[16%] ww:text-base xx:text-[15px] dd:text-[14px] ss:text-[13px] \">".concat(t, "</p>\n                    <p class=\"  basis-[16%] ww:text-base xx:text-[15px] dd:text-[14px] ss:text-[13px] \">").concat(l, "</p>\n                    <p class=\"  basis-[16%] ww:text-base xx:text-[15px] dd:text-[14px] ss:text-[13px] \">").concat(c, "</p>\n                    <p class=\"  basis-[16%] ww:text-base xx:text-[15px] dd:text-[14px] ss:text-[13px] \">").concat(d, "</p>\n                    <p class=\"  border-2 border-slate-400 p-1 rounded-2xl ww:text-base xx:text-[15px] dd:text-[14px] ss:text-[13px] \">").concat(q, "</p>\n                    <svg id=\"").concat(id, "\" role=\"button\" tabindex=\"0\" aria-label=\"Delete product\"\n                        class=\" pdt-dlt-btn stroke-red-500 dd:h-6 dd:w-6 ss:h-5 ss:w-5 cursor-pointer focus:outline-none focus:ring-2 focus:ring-green-600 rounded\"\n                        xmlns=\"http://www.w3.org/2000/svg\" fill=\"none\"\n                        viewBox=\"0 0 24 24\" stroke-width=\"1.5\" stroke=\"currentColor\">\n                        <path stroke-linecap=\"round\" stroke-linejoin=\"round\"\n                            d=\"m14.74 9-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 0 1-2.244 2.077H8.084a2.25 2.25 0 0 1-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 0 0-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 0 1 3.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 0 0-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 0 0-7.5 0\" />\n                    </svg>\n                </li>\n            ");
      });
    ...
    value: function toggleProductQty(e) {
      ...
      var current = (0, _utils.clampQuantity)(this.pdtQty.innerText);
      if (e.currentTarget.id === "incQty") {
        this.pdtQty.innerText = current + 1;
      } else if (e.currentTarget.id === "decQty") {
        if (current === 0) {
          (0, _toast.showToast)("Quantity cannot be negative", "error", {
            key: "qtyFloor",
            lockMs: 600
          });
          return;
    ...
    value: function deleteProduct(e) {
      ...
      this.showListedProducts(_storage["default"].getProducts);
      this.sortBySelect(this.sortSelect.value);
      (0, _toast.showToast)("Product deleted", "success");
    }
  }, {
    key: "searchProducts",

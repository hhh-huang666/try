...
var translations = exports.translations = {
  en: {
    ...
    privacyMetaDesc: "Privacy Policy for the Inventory App, describing how local browser storage is used.",
    privacyLastUpdated: "Last updated: 19 April 2026",
    privacyS1Title: "1. Overview",
    privacyS1Body: "This Inventory App is a client-side web application. We do not operate a backend server that stores your data, and we do not collect, share, or sell personal information to third parties.",
    privacyS2Title: "2. Data We Store",
    privacyS2PBefore: "All product and category information you create is stored exclusively in your browser via ",
    privacyS2PAfter: ". This data never leaves your device.",
    privacyS2Li1: "products — items you add (title, quantity, category, location, timestamp).",
    ...
    privacyS3BeforeCode: "The app loads Google Fonts (Outfit, Vazirmatn) from ",
    privacyS3AfterCode: ". Google may log the IP address used to fetch these fonts per its own privacy policy.",
    privacyS4Title: "4. Your Rights",
    privacyS4BeforeCode: "You can clear all stored data at any time by clearing your browser's site data for this origin, or by opening DevTools and running ",
    privacyS4AfterCode: ".",
  ...
  zh: {
    ...
    privacyS1Title: "1. 概述",
    privacyS1Body: "本库存管理应用为纯前端网页应用。我们不运营用于存储您数据的后端服务器，也不会向第三方收集、共享或出售个人信息。",
    privacyS2Title: "2. 我们存储的数据",
    privacyS2PBefore: "您创建的所有产品与分类信息仅保存在浏览器的 ",
    privacyS2PAfter: " 中，这些数据不会离开您的设备。",
    privacyS2Li1: "products — 您添加的商品条目（标题、数量、分类、位置、时间戳）。",
    ...
    privacyS3AfterCode: " 加载 Google 字体（Outfit、Vazirmatn）。Google 可能会依据其自有隐私政策记录用于获取这些字体的 IP 地址。",
    privacyS4Title: "4. 您的权利",
    privacyS4BeforeCode: "您可以随时通过清除浏览器中本网站的站点数据来删除所有已存储内容，也可以打开开发者工具并执行 ",
    privacyS4AfterCode: "。",
